...
export default function OrgAdminDashboard() {
  ...
  // 1. Initial State se org_emp_code remove:
  ...
  const handleCreateEmployee = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Form submission reset handler cleanup:
      setEmployeeForm({
        email: '', password: '', first_name: '', last_name: '',
        designation: '', band: '', department: '',
    ...
    <div className="min-h-screen bg-slate-50 p-8 space-y-8">
      ...
      <div className="flex gap-4 border-b border-slate-200 pb-2">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors ${activeTab === 'employees' ? 'bg-blue-600 text-white' : 'bg-white text-slate-600 border border-slate-200 hover:bg-slate-100'
            }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors ${activeTab === 'add_employee' ? 'bg-blue-600 text-white' : 'bg-white text-slate-600 border border-slate-200 hover:bg-slate-100'
            }`}
        >
